...
if ($ref!="")
	...
	<meta http-equiv="refresh" content="0;url=<?=$baseurl?>/view.php?ref=<?=$ref?>">
	<title><?=trim($resource["title"])?></title></head>
	<body style="color:white;background-color:white;"><h1><?=trim($resource["title"])?></h1>
	<?
	for ($n=1;$n<count($resourcedata);$n++)
		{
