...
$email_from="dan@huby.me.uk"; # Where e-mails appear to come from
$email_notify="dan@huby.me.uk"; # Where resource/research/user requests are sent
$spider_password="TBTT6FD"; # The password required for spider. - IMPORTANT - randomise this for each new installation. Your resources will be readable by anyone that knows this password.
...
$password_min_uppercase=1; # Minimum number of upper case alphabetical characters (a-z, A-Z)
...
# Additional custom fields when new users apply for an account
# Uncomment the line and set the field names, comma separated
$custom_registration_fields="Organization,Job Title,Contact Number,Country";
#$custom_registration_required="Organization,Job Title";

# When requesting feedback, allow the user to select resources (e.g. pick preferred photos from a photo shoot).
$feedback_resource_select=true;

$preview_generate_max_file_size=3;
...
# Is the FLV preview downloadble?
...
$default_user_select="dan@montala.net";

#if exiftool is installed, you can optionally enable the metadata report available on the View page.  
$metadata_report=true;


$custom_home_panels[0]["title"]="Custom Panel 1";
$custom_home_panels[0]["text"]="Custom Panel Text 1";
$custom_home_panels[0]["link"]="search.php?search=example";

$custom_home_panels[1]["title"]="B&H Virginia";
$custom_home_panels[1]["text"]="";
$custom_home_panels[1]["link"]="search.php?search=example";
$custom_home_panels[1]["height"]="30px;";

$custom_home_panels[2]["title"]="Custom Panel 3";
$custom_home_panels[2]["text"]="Custom Panel Text 3";
