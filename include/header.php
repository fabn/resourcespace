...
<?php if (isset($anonymous_login) && ($username==$anonymous_login))
	...
	<a href="<?php echo $baseurl?>/pages/change_password.php"><?php } ?><?php echo $userfullname?><?php } /* end replacefullnamelink */?><?php if ($allow_password_change && !checkperm("p")) { ?></a><?php } ?></li>
