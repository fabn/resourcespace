...
<?php } ?>
		...
		<?php if ($top_nav_upload && checkperm("t") && checkperm("c")) { ?><li><a target="<?php echo $target?>" href="<?php echo $baseurl?>/pages/edit.php?ref=-<?php echo $userref?>&amp;<?php echo $top_nav_upload_type ?>=true"><?php echo $lang["upload"]?></a></li><?php } ?>
