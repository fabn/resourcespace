...
function errorhandler($errno, $errstr, $errfile, $errline)
	...
	if (!isset($pagename) || $pagename!="upload_java")
		...
		<?php if ($show_report_bug_link){?><p style="font-size:11px;color:black;">If this problem persits you can <a href="<?php echo $baseurl?>/pages/team/team_reportbug.php?errortext=<?php echo urlencode("$errfile line $errline: $errstr");?>">submit a bug report.</a><br/>(Login to <a href="http://bugs.resourcespace.org/">http://bugs.resourcespace.com/</a> first.)</p><?php }?>
