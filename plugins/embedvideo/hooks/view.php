...
<p id="embedvideo2" style="display:none;padding:10px 0 3px 0;"><?php echo $lang["embed_help"] ?></p>
<textarea id="embedvideo" style="width:335px;height:200px;display:none;"><?php echo htmlspecialchars('
