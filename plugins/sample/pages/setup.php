...
//    the array $lang['sample_pet_type_list']. For the UI the textual description for 
//    this variable is in $lang['sample_pets_owned']. We use config_add_multi_select()
//    because we want a multi-select UI for this variable.
// 2) $sample_favorite_pet_type is a string variable whose value is drawn from the array
//    $lang['sample_pet_type_list']. Its UI description is in 
