...
<form method=post onSubmit="if (($('usagecomment').value=='') || ($('usage').value=='')) {alert('<?php echo $lang["usageincorrect"] ?>');return false;}">
...
<select class="stdwidth" name="usage">
...
<input name="save" type="submit" value="&nbsp;&nbsp;<?php echo $lang["download"]?>&nbsp;&nbsp;" />
</div>
</form>
</div>
