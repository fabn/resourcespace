...
?>
<object type="application/x-shockwave-flash" data="../lib/flashplayer/player_flv.swf" width="<?php echo $ffmpeg_preview_max_width?>" height="<?php echo $ffmpeg_preview_max_height?>" class="Picture">
     <param name="movie" value="../lib/flashplayer/player_flv.swf" />
     <param name="FlashVars" value="flv=<?php echo $flashpath?>&amp;width=<?php echo $ffmpeg_preview_max_width?>&amp;height=<?php echo $ffmpeg_preview_max_height?>&amp;margin=0&amp;buffer=10&amp;autoload=0&amp;showstop=1&amp;playercolor=<?php echo $colour?>" />
</object>