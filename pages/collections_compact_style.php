...
<?php if ((!collection_is_research_request($collection)) || (!checkperm("r"))) { ?>
	<?php if ($contact_sheet==true && $collections_compact_style) { ?><option value="contactsheet_settings.php?ref=<?php echo $collection?>"><?php echo $lang["contactsheet"]?></option><?php } ?>
    <?php if ($allow_share) { ?><option value="collection_share.php?ref=<?php echo $collection?>"><?php echo $lang["share"]?></option><?php } ?>
	...
	<?php if ($preview_all){?><option value="preview_all.php?ref=<?php echo $collection?>"><?php echo $lang["preview_all"]?></option><?php } ?>
    <?php if ($feedback) {?><option value="collection_feedback.php?collection=<?php echo $collection?>&k=<?php echo $k?>"><?php echo $lang["sendfeedback"]?></option><?php } ?>
    <?php } else {
