...
foreach ($countries as $country)
	...
	if ($found)
		{
		echo "<li>Country $country: code found: $code</li>";
		...
		foreach ($coords as $coord)
			{
			$s=explode(",",$coord);
			if (count($s)==3 && $s[0]==$code)	
				{
				echo "Coords found: " . $s[1] . "/" . $s[2] . " for keyref " . $countries_keyrefs[$country];
		...
		{
		echo "<li>Country code not found for $country.</li>";
		}
