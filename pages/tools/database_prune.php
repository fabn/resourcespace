...
echo mysql_affected_rows() . " orphaned collections deleted.<br/><br/>";
...
echo mysql_affected_rows() . " orphaned collection keywords deleted.<br/><br/>";

sql_query("delete from collection_log where collection not in (select ref from collection)");
echo mysql_affected_rows() . " orphaned collection log rows deleted.<br/><br/>";
...
echo mysql_affected_rows() . " orphaned collection saved searches deleted.<br/><br/>";

sql_query("delete from external_access_keys where resource not in (select ref from resource)");
echo mysql_affected_rows() . " orphaned external access keys deleted.<br/><br/>";

sql_query("delete from ip_lockout");
echo mysql_affected_rows() . " IP address lock-outs deleted.<br/><br/>";

sql_query("delete from resource_keyword where resource not in (select ref from resource)");
echo mysql_affected_rows() . " orphaned resource-keyword relationships deleted.<br/><br/>";
...
echo mysql_affected_rows() . " unused keywords deleted.<br/><br/>";

sql_query("delete from resource_alt_files where resource not in (select ref from resource)");
echo mysql_affected_rows() . " orphaned alternative files deleted.<br/><br/>";
...
echo mysql_affected_rows() . " orphaned resource custom access rows deleted.<br/><br/>";
...
echo mysql_affected_rows() . " orphaned resource related rows deleted.<br/><br/>";
