...
// just an idea, this may or may not be efficient, the idea is to eventually limit this to the loaded area 
...
// do the same with image src tags   
    ...
    // do the same with form action   
        jQuery('form').not('[action^="http"],[action^="https"],[action^="#"]').each(function() {
