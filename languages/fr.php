...
$lang["emailtousers"]="Envoyer aux utilisateurs<br />(utilisez les adresses de courriel pour les non-inscrits)";
$lang["emailcollection"]="Envoyer la collection par courriel";
...
$lang["useralreadyexists"]="Un compte avec ce courriel ou cet identifiant existe déjà. Vos modifications n'ont pas été enregistrées";
$lang["ticktoemail"]="Cochez pour Envoyer à cet utilisateur son identifiant et mot de passe par courriel";
...
$lang["researchrequestassignedmessage"]="Votre demande de recherche a été assignée à un membre de notre équipe. Une fois que nous aurons terminé la recherche, vous recevrez un courriel avec un lien vers les documents que nous vous recommandons.";
...
$lang["action-email"]="Envoyer par courriel";
...
$lang["addresourcebatchftp"]="Ajouter un lot de documents - FTP";
...
$lang["requestfeedback"]="Demande de commentaires<br />(la réponse vous sera envoyée par courriel)";
...
$lang["cannotemailpassword"]="Vous ne pouvez pas envoyer aux utilisateurs leur mot de passe actuel par courriel car il n'est pas enregistré (un hachage cryptographique est enregistré à la place).<br/><br/> Vous devez utiliser le bouton 'Suggérer' ci-dessus pour générer un nouveau mot de passe et activer la fonction d'envoi par courriel.";
