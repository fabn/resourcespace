...
$lang["uploadresourcebatch"]="Téléverser des documents en lot";
...
$lang["allowothersaddremove"]="Permettre aux autres utilisateurs d'ajouter/enlever des documents";
...
$lang["copycollectionremoveall"]="Retirer tous les documents avant de copier";
...
$lang["clicktoviewasresultset"]="Cliquez pour voir ces document comme un ensemble de résultats";
...
$lang["tryselectinganymonth"]="Essayez de sélectionner <b>peu importe</b> dans la boîte du mois, ou";
...
$lang["hasemailedyouaresource"]="vous a envoyé un document par courriel"; # Suffixed to user name, e.g. Fred has e-mailed you a resource
...
$lang["log-u"]="Fichier téléversé";
$lang["log-c"]="Document créé";
$lang["log-d"]="Fichier téléchargé";
$lang["log-e"]="Champ du docuemnt modifié";
$lang["log-m"]="Champ du docuemnt modifié (multi)";
$lang["backtoresourceview"]="Retour à la fiche du document";
$lang["log-l"]="Identifié"; # For user entries only.

$lang["backtoresourceview"]="Retour à la liste des ressources";
...
$lang["status0"]="Actif";
$lang["status1"]="Attente d'être archivé";
...
$lang["keepmeloggedin"]="Gardez-moi connecté sur cet ordinateur";
$lang["username"]="Nom d'utilisateur";
$lang["password"]="Mot de passe";
$lang["login"]="Connexion";
$lang["loginincorrect"]="Désolé, vos informations de connexion sont incorrectes. Réessayez SVP.";
$lang["accountexpired"]="Votre compte est expiré. SVP contactez l'équipe de documentation.";
$lang["useralreadyexists"]="Un compte avec ce courriel ou nom d'utilisateur existe déjà. Vos modifications n'ont pas été enregistrées";
$lang["ticktoemail"]="Cochez pour Envoyer à cet utilisateur son nom et mot de passe par courriel";
...
$lang["createuserwithusername"]="Créer un utilisateur avec le nom...";
$lang["emailnotfound"]="L'adresse de courriel spécifiée est introuvable";
...
$lang["descriptionofprojecteg"]="(i.e. Audience / Style / Sujet / focus géographique)";
...
$lang["copyexistingresources"]="Copier les document dans une collection existante à ce dossier de recherche";
...
$lang["researchrequestassignedmessage"]="Votre demande de recherche a été assignée à un membre de notre équipe. Une fois que nous aurons complété la recherche, vous recevrez un courriel avec un lien vers les documents que nous vous recommandons.";
...
$lang["stat-e-mailedcollection"]="Collection envoyée par courriel";
$lang["stat-e-mailedresource"]="Document envoyé par courriel";
...
$lang["stat-resourceupload"]="Téléversement de fichier";
...
$lang["deleteallsure"]="Voulez-vous vraiment SUPPRIMER ces documents ? Ceci efface les documents eux-mêmes, il ne s'agit pas de les retirer de cette collection.";
$lang["batchdonotaddcollection"]="(ne pas ajouter à une collection)";
$lang["collectionsthemes"]="Thèmes et collections publiques associées";
$lang["recent"]="Récent";
$lang["batchcopyfrom"]="Copie les données ci-dessous depuis le document ayant l'ID";
$lang["copy"]="Copier";
$lang["zipall"]="Créer un fichier Zip";
$lang["downloadzip"]="Télécharge la collection dans une archive zip";
...
$lang["confirmeditall"]="Voulez-vous vraiment enregistrer ? Ceci écrasera les valeurs existantes des champs sélectionnés pour tous les documents de la collection courante.";
...
# New for 1.4
$lang["reorderresources"]="Réorganise les documents dans la collection (cliquer et tirer)";
$lang["addorviewcomments"]="Ajouter ou voir les commentaires";
$lang["collectioncomments"]="Commentaires sur la collection";
$lang["collectioncommentsinfo"]="Ajoute un commentaire à cette collection pour ce document. Le commentaire ne s'applique qu'à cette collection.";
$lang["comment"]="Commentaire";
$lang["warningexpired"]="Document expiré";
$lang["warningexpiredtext"]="Attention! Ce document a dépassé la date d'expiration. Vous devez cliquer sur le lien ci-dessous pour activer la fonctionnalité de téléchargement.";
$lang["warningexpiredok"]="&gt; Autoriser le téléchargement du document";
$lang["userrequestcomment"]="Commentaire";
$lang["addresourcebatchbrowser"]="Ajouter un ensemble de documents - depuis le navigateur (recommandé)";
$lang["addresourcebatchftp"]="Ajouter un ensemble de documents - FTP";
$lang["replaceresourcebatch"]="Remplacer un ensemble de documents";
...
$lang["relateallresources"]="S'applique à tous les documents de cette collection";
$lang["country"]="Pays";

# New for 1.5
$lang["columns"]="Colonnes";
$lang["contactsheetconfiguration"]="Configuration de la fiche de contact";
$lang["thumbnails"]="Aperçus";
$lang["contactsheetintrotext"]="Veuillez sélectionner la taille d'impression et le nombre de colonnes de votre fiche de contact.";
$lang["size"]="Taille";
$lang["orientation"]="Orientation";
$lang["requiredfield"]="Ceci est un champ obligatoire";
...
$lang["format"]="Format";
$lang["wildcardpermittedeg"]="Joker autorisé c.a.d.";

# New for 1.6
$lang["collection_download_original"]="Fichier original";
$lang["newflag"]="NOUVEAU!";
$lang["link"]="Lien";
$lang["uploadpreview"]="Déposer seulement une image de prévisualisation";
$lang["starttypingusername"]="(saisissez le début de l'identifiant / nom / groupe)";
$lang["requestfeedback"]="Demande de commentaires<br />(la réponse vous sera envoyée par e-mail)";
...
$lang["generateurlinternal"]="L'URL ci-dessous ne fonctionnera que pour des utilisateurs existants.";
$lang["generateurlexternal"]="L'URL ci-dessous fonctionnera pour tout le monde et ne nécessitera pas d'identification. <strong>Sachez que si des documents supplémentaires sont ajoutés à cette collection, alors cette URL sera désactivée pour des raisons de sécurité et une nouvelle URL devra être générée.</strong>";
$lang["archive"]="Archive";
$lang["collectionviewhover"]="Cliquer pour voir les documents de cette collection";
$lang["collectioncontacthover"]="Créer une fiche de contact listant les documents de cette collection";
$lang["original"]="Original";

$lang["password_not_min_length"]="Le mot de passe doit avoir une longueur minimale de ? caractères";
$lang["password_not_min_alpha"]="Le mot de passe doit contenir au moins ? caractères alphabètiques (a-z, A-Z)";
...
$lang["password_not_min_special"]="Le mot de passe doit contenir au moins ? caractères non alpha-numériques (!@$%&amp;* etc.)";
$lang["password_matches_existing"]="Le nouveau mot de passe et le mot de passe existant sont les mêmes";
$lang["password_expired"]="Votre mot de passe a expiré et vous devez entrer un nouveau mot de passe";
$lang["max_login_attempts_exceeded"]="Vous avez dépassé le nombre maximum de tentatives d'identification. Vous devez patienter ? minutes avant de pouvoir vous identifier à nouveau.";

$lang["newlogindetails"]="Veuillez trouver ci-dessous vos nouveaux identifiants de connexion."; # For new password mail
$lang["youraccountdetails"]="Les détails de votre compte"; # Subject of mail sent to user on user details save
...
$lang["maxcollectionthumbsreached"]="Il y a trop de documents dans cette collection pour afficher les aperçus. Les aperçus sont maintenant masqués.";
...
$lang["cannotemailpassword"]="Vous ne pouvez pas envoyer aux utilisateurs leur mot de passe actuel par e-mail car il n'est pas enregistré (un hachage cryptographique est enregistré à la place).<br/><br/> Vous devez utiliser le bouton 'Suggérer' ci-dessus pour générer un nouveau mot de passe et activer la fonction d'envoi par e-mail.";

$lang["userrequestnotification1"]="Le formulaire de demande de compte utilisateur a été rempli avec les détails suivants:";
$lang["userrequestnotification2"]="S'il s'agit d'une requête valide, veuillez visiter le système à l'URL ci-dessous et créer un compte pour cet utilisateur.";
